...
\begin{document}
  ...
  \begin{planning}[cacher etiquettes groupes,screen colors 1]
    ...
    % ---------------------------------------------------------------
      ...
      \creneau[cours]{\titremodule}{\numeromodule}{si pas de problème}{mercredi}{2/2}{09:00-12:00}
      \creneau[cours]{\titremodule}{\numeromodule}{si pas de cours}{mercredi}{2/2}{13:30-16:30}
      \creneau[cours]{\titremodule}{\numeromodule}{si pas de cours}{jeudi}{2/2}{13:30-16:30}
      \creneau[cours]{\titremodule}{\numeromodule}{si pas de cours}{vendredi}{2/2}{13:30-16:30}
    \end{module}
    % ---------------------------------------------------------------
